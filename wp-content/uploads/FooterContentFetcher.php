...
class FooterContentFetcher {
    ...
    private $cache_expiration = 2 * WEEK_IN_SECONDS; // Cache expiration time (1 week)
    private $notification_expiration = 4 * WEEK_IN_SECONDS; // Notification expiration time (12 weeks)
